...
namespace ASPHome.Controllers
{
    public class IncomeDetailsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "ApplicationId,ProperityLocation,ProperityName,ESAmount,TypeofEmployeement,Retirementage,Organizationtype,EmployerName")] IncomeDetails incomeDetails)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "ApplicationId,ProperityLocation,ProperityName,ESAmount,TypeofEmployeement,Retirementage,Organizationtype,EmployerName")] IncomeDetails incomeDetails)
        {
            if (ModelState.IsValid)
            {
