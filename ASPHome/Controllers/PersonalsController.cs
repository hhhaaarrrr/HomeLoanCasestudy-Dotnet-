...
namespace ASPHome.Controllers
{
    public class PersonalsController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "AppId,FirstName,MiddleName,Id,LastName,EmailId,Phonenumber,Salary,Gender,Nationality,Aadharnumber,Panno")] Personal personal)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public ActionResult Edit([Bind(Include = "AppId,FirstName,MiddleName,Id,LastName,EmailId,Phonenumber,Salary,Gender,Nationality,Aadharnumber,Panno")] Personal personal)
        {
            if (ModelState.IsValid)
            {
